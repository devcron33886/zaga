                            ...
                            <table class="min-w-full divide-y divide-gray-300">
                                <thead class="bg-gray-50 divide-y divide-gray-100">
                                    <tr class="divide-x divide-gray-100">
                                        ...
                                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Sauna Amount</th>
                                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Massage Amount</th>
                                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Gym Amount</th>
                                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Bar and Kitchen</th>
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    ...
                                    <tr class="divide-x divide-gray-100">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900">{{ $work->formattedSauna() }}</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900">{{ $work->formattedMassage() }}</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900">{{ $work->formattedGym() }}</td>

                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900">{{ $work->formattedBarAndKicthen() }}</td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">{{ Cknow\Money\Money::RWF($sauna) }}</td>
                                        <td class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">{{ Cknow\Money\Money::RWF($massage) }}</td>
                                        <td class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">{{ Cknow\Money\Money::RWF($gym) }}</td>
                                        <td class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">{{ Cknow\Money\Money::RWF($bar_and_kitchen) }}</td>
